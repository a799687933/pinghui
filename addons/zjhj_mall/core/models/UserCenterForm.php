            ...
            'menus' => [
                ...
                [
                  ...
                  [
                    'id' => 'shopping',
                    'name' => '购物车',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-shopping.png',
                    'open_type' => 'navigator',
                    'url' => '/pages/cart/cart',
                    'tel' => '',
                ],
                [
                    'id' => 'order',
                    'name' => '全部订单',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-order.png',
                    'open_type' => 'navigator',
                ...
                [
                    'id' => 'footstep',
                    'name' => '足迹',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/user-center/icon-footstep.png',
                    'open_type' => 'navigator',
                    'url' => '/pages/footstep/footstep',
                    'tel' => '',
                ],
                [
                    'sign' => 'miaosha',
