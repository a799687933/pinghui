        ...
        <form class="auto-form" method="post" return="<?= $returnUrl ?>">
            ...
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label required">商品拼团编辑</label>
                        </div>
                        <div class="col-9">
                              <a target="_blank" class="btn btn-sm btn-primary"
                           href="<?= $urlManager->createUrl([$urlStr . 'mch/group/goods/goods-edit', 'id' => $goods->id]) ?>">点此去编辑此拼团商品</a>
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-3 text-right">
             ...
             <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class="col-form-label required">商品首页图</label>
                        </div>
                        <div class="col-9">
                            <div class="upload-group short-row">
                                <div class="input-group">
                                    <input class="form-control file-input" name="model[cover_pic_index]"
                                           value="<?= $goods->cover_pic_index ?>">
                                    <span class="input-group-btn">
                                        <a class="btn btn-secondary upload-file" href="javascript:"
                                           data-toggle="tooltip"
                                           data-placement="bottom" title="上传文件">
                                ...
                                <div class="upload-preview text-center upload-preview">
                                    <span class="upload-preview-tip">700&times;400</span>
                                    <img class="upload-preview-img" src="<?= $goods->cover_pic_index ?>">
                                </div>
                            </div>
                        </div>
                    </div>
