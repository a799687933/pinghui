                    ...
                    <form method="post" class="auto-form" autocomplete="off"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group row" style="display: none">
                                ...
                                <div class="col-5">
                                    <div class="input-group">
                                        <input readonly="readonly" class="form-control" name="discount" value="<?=10 ?>">
                                        <span class="input-group-addon bg-white">折</span>
                                    </div>
                                    <div class="text-muted fs-sm">请输入0.1~10之间的数字(10折代表不打折)</div>
                                </div>
                            </div>

                         <div class="form-group row">
                                <div class="col-2 text-right">
                                    <label class="col-form-label required">佣金比例</label>
                                </div>
                                <div class="col-5">
                                    <div class="input-group">
                                        <input class="form-control" name="reco_ratio" value="<?= $level->reco_ratio ?>">
                                        <span class="input-group-addon bg-white">百分比</span>
                                    </div>
