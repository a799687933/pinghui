...
<div class="panel mb-3" id="page">
    ...
    <div class="panel-body">
        ...
        <form class="form auto-form" method="post" autocomplete="off" data-return="<?= $returnUrl ?>">
            ...
            <input type="hidden" name="model[cat_id]" value="1">
           <!--  <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                    ...
                    <div class="form-group row">
                        <div class="col-3 text-right">
                            <label class=" col-form-label">商城商品拉取<br> </label>
                        </div>
                        <div class="col-9">
                            <div class="input-group short-row">
 ...
 -->
            <div class="step-block" flex="dir:left box:first">
                ...
                <div>
                            ...
                            <input class="form-control short-row"  type="hidden" name="model[id]"
                                   value="<?= $goods['id']?$goods['id']: explode("=",$returnUrl)[2] ?>">
