        ...
        return [
            'menus' => [
                ...
                //调试分销图标
                 'flow'=>[
                    'name' => '数据统计',
                   'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/share-custom/img-share-flow.png',
                    'open_type' => 'navigator',
                    'url' => '/pages/share-flow/share-flow',
                    'tel' => '',
                ],
                  //推广素材
                 'material'=>[
                    'name' => '推广素材',
                   'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/share-custom/img-share-material.png',
                    'open_type' => 'navigator',
                    'url' => '/pages/share-materia/share-material',
                    'tel' => '',
                ],
                //每日一课
                 'oneclass'=>[
                    'name' => '每日一课',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/share-custom/img-share-oneclass.png',
                    'open_type' => 'navigator',
                    'url' => '/pages/share-oneclass/share-oneclass',
                    'tel' => '',
                ],
             //推广等级
                 'reco_level'=>[
                    'name' => '推广等级',
                    'icon' => \Yii::$app->request->hostInfo . \Yii::$app->request->baseUrl . '/statics/images/share-custom/img-share-reco_level.png',
                    'open_type' => 'navigator',
                    'url' => '/pages/share-reco_level/share-reco_level',
                    'tel' => '',
                ],
