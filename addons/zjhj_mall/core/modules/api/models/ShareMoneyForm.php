...
class ShareMoneyForm extends ApiModel
{
    ...
    public function setData()
    {
        ...
        $reco_ratio= level::findOne(['level' => $user->level])['reco_ratio'];
        ...
        foreach ($orderDetail as $item) {
            ...
            if ($shareType == 1) {
                ...
                $share_commission_money_first += $item_price * $rate_first / 100* $reco_ratio/ 100;
                $share_commission_money_second += $item_price * $rate_second / 100* $reco_ratio/ 100;
                $share_commission_money_third += $item_price * $rate_third / 100* $reco_ratio/ 100;
            }
        }
